...
/*
author: Muaz Latif
In this assignment I checked all the values of Z[k*2] and Z[k*2+1]
and compared them with eachother, and if they had a difference of more than 1000 
I zeroed out the Z[k*2] value.
*/
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
